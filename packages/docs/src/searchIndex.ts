export default [
	...
	},
	{
		path: 'tooltips',
		title: 'Tooltips',
		text: 'Tooltips provide contextual information when users hover over chart elements. When tooltip.alwaysShowRulerTooltip is set to true, the tooltip will display ruler lines and values continuously as the user moves their cursor across the chart, making it easier to read precise values and compare data points across different series. Details on Tooltip options can be found here.',
		charts: [
			'Scatter (linear x & y)',
			'No. of employees',
			'Annual sales',
			...
			'order count',
			'product count',
			'Scatter (tooltip.alwaysShowRulerTooltip=true)',
			'No. of employees',
			'Annual sales',
			'Line (discrete)',
			...
			'Rotated ticks (line)',
			'Log Axis',
			'Line (tooltip.alwaysShowRulerTooltip=true)',
			'2023 Annual Sales Figures',
			'Conversion rate',
			'Line (empty state)',
			'2023 Annual Sales Figures',
			...
			'2023 Annual Sales Figures',
			'Conversion rate',
			'Area (tooltip.alwaysShowRulerTooltip=true)',
			'2023 Annual Sales Figures',
			'Conversion rate',
			...
			'No. of employees',
			'Annual sales',
			'Bubble (tooltip.alwaysShowRulerTooltip=true)',
			'2023 Annual Sales Figures',
			'Bubble (discrete)',
			'2023 Annual Sales Figures',
			'Bubble (time series)',
			...
			'Temperature (°F)',
			'Day of the Week',
			'Combo (tooltip.alwaysShowRulerTooltip=true)',
			'USA Summer School Attendance',
			'Temperature (°F)',
			'Day of the Week',
			...
			'Age',
			'No. of participants',
			'Histogram (tooltip.alwaysShowRulerTooltip=true)',
			'Age',
			'No. of participants',
