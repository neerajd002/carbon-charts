...
- **yarn:** error in the lock file for date-fns
  ([396e9c4](https://github.com/carbon-design-system/carbon-charts/commit/396e9c4))
...
- **angular:** add v8 to angular peerDependencies
  ([c147419](https://github.com/carbon-design-system/carbon-charts/commit/c147419))
...
- **charts-angular:** update build toolchain
  ([aa63925](https://github.com/carbon-design-system/carbon-charts/commit/aa63925))
...
- **angular:** update zone.js peerDependency range
  ([15cbddd](https://github.com/carbon-design-system/carbon-charts/commit/15cbddd))
...
- **core:** run lerna builds in a stream
  ([ce35e40](https://github.com/carbon-design-system/carbon-charts/commit/ce35e40))
...
- **Angular:** Export base chart in Angular module
  ([99fdd29](https://github.com/carbon-design-system/carbon-charts/commit/99fdd29))
...
- **Angular:** Add Scatter to the Angular package, storybook and readme
  ([3f62714](https://github.com/carbon-design-system/carbon-charts/commit/3f62714))
- **scatter:** Add Scatter to the Angular package and storybook
  ([2aac850](https://github.com/carbon-design-system/carbon-charts/commit/2aac850))
...
- **build:** add npm credentials
  ([#226](https://github.com/carbon-design-system/carbon-charts/issues/226))
  ([93e0ff7](https://github.com/carbon-design-system/carbon-charts/commit/93e0ff7))
...
- **angular:** Fix demos and build process
  ([245bb12](https://github.com/carbon-design-system/carbon-charts/commit/245bb12))
...
- **$browser:** Add y axis
  ([8e2a86b](https://github.com/carbon-design-system/carbon-charts/commit/8e2a86b))
- **$browser:** Y axis titles
  ([7e03ff7](https://github.com/carbon-design-system/carbon-charts/commit/7e03ff7))
...
- **$browser:** Use dynamic step value for margin instead of fixed value.
  ([b9910f0](https://github.com/carbon-design-system/carbon-charts/commit/b9910f0))
- **core:** Fix axis alignment for LineChart
  ([c9f5124](https://github.com/carbon-design-system/carbon-charts/commit/c9f5124))
- **core:** Fix axis alignment in LineChart
  ([18b44a6](https://github.com/carbon-design-system/carbon-charts/commit/18b44a6))
...
- **angular:** Bundle angular wrapper components using angular package format
  ([352166a](https://github.com/carbon-design-system/carbon-charts/commit/352166a))
...
- **core:** changed threshold config format, refactored code
  ([8271615](https://github.com/carbon-design-system/carbon-charts/commit/8271615))
- **core:** changed threshold config format; refactored code
  ([94a9d37](https://github.com/carbon-design-system/carbon-charts/commit/94a9d37))
...
- **monorepo:** release on npm on release branches in travis
  ([2e79450](https://github.com/carbon-design-system/carbon-charts/commit/2e79450))
